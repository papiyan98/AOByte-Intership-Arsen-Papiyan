...
5. Each column must have 2 buttons
  * "+" adds the post with highest average rating from the pool to a column
  ...
  * "sort" toggles the sorting direction of the posts (from ascending to descending and vice versa)
