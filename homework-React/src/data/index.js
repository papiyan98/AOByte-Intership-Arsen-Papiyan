export const pool = [
  ...
  {id: 6, title: 'Post 6 Title', description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusantium nam provident tempora sequi nobis? Voluptatibus similique illo consequatur assumenda a, iusto rem ullam mollitia cum eaque corporis? Aperiam, adipisci corrupti neque consequuntur, sint qui nihil hic nemo molestias vitae ducimus?', comments: [
    {commentor: "Alex", text: 'A bit strange.', rate: 5, replies: [], date: new Date(2023, 6, 11, 12, 35, 20).getTime(), isDeletable: false}
  ]},
  ...
  {id: 8, title: 'Post 8 Title', description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusantium nam provident tempora sequi nobis? Voluptatibus similique illo consequatur assumenda a, iusto rem ullam mollitia cum eaque corporis? Aperiam, adipisci corrupti neque consequuntur, sint qui nihil hic nemo molestias vitae ducimus?', comments: [
    {commentor: "Leyla", text: 'Enjoy!', rate: 5, replies: [], date: new Date(2023, 6, 20, 13, 35, 20).getTime(), isDeletable: false}
  ]},
  ...
  {id: 12, title: 'Post 12 Title', description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Accusantium nam provident tempora sequi nobis? Voluptatibus similique illo consequatur assumenda a, iusto rem ullam mollitia cum eaque corporis? Aperiam, adipisci corrupti neque consequuntur, sint qui nihil hic nemo molestias vitae ducimus?', comments: [
    {commentor: "Charlotte", text: 'Enjoy!', rate: 5, replies: [], date: new Date(2023, 6, 20, 13, 35, 20).getTime(), isDeletable: false}
  ]},
];